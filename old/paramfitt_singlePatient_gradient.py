...
def get_params_bounds():
    ...
    #'param1_Pdeath': (1e-5, 1e-1),  #sigmoid(1e-2, 1e2) ,      #linear #parameterscan zu unsensibel
    #'param2_Pdeath':  (0, 10), #sigmoid(1e-2,1e3) ,     #parameterscan zu unsensibel
    #'param3_Pdeath': (5, 18),
...
if __name__ =='__main__':
    ...
    # LHS
    num_samples = 100                                      # number of LHS samples to generate
    ...
    output= {
        'metadata': {
            'description': 'k_P_death linear, ohne iE, 5x durchlauf, mit fixed update function, ohne hill',
